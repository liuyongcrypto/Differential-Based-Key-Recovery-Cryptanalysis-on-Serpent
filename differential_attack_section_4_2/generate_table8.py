...
# Use a set to store already processed combinations and avoid redundant work when different i0, i1 selections generate identical A_sets structures 
visited_configs = set() 
    ...
    for i1 in range(i0+1,5): 
        for i2 in range(i1+1,5): 
            for i3 in range(i2+1,5): 
                ...
                # Convert to a tuple and add it to the set to remove duplicate configurations, preventing different i0, i1 combinations from generating exactly the same input combinations 
